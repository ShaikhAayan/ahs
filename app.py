...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/ShaikhAayan' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/aayan-shaikh-12081b282/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Harini ,Aayan and Sonali</b>
                </a>
            </p>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Awesome Hacking](https://github.com/ShaikhAayan)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [30-Days-Of-Rust](https://github.com/ShaikhAayan)", icon="ℹ️")
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'unnamed.jpg'}"
                     alt="HAS
                     class="profile-image"
                     onerror="this.onerror=null; this.src='unnamed.jpg';">
                <h2 class="profile-name">HAS</h2>
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.linkedin.com/in/aayan-shaikh-12081b282/" class="social-link" target="_blank">
                ...
                <p class="bio-text">
    Hello! I'm <strong>Aayan Shaikh</strong>, a passionate Full Stack Developer with expertise in AI and Machine Learning.
...
<p class="bio-text">
    Hello! I'm <strong>Harini</strong>, an enthusiastic Frontend Developer with a strong focus on creating seamless and 
    user-friendly interfaces. At Smart Resume AI, I’ve contributed to building an engaging 
    and intuitive design that ensures users have a smooth experience while optimizing their resumes.
</p>

<p class="bio-text">
    Hello! I'm <strong>Sonali</strong>, a dedicated Backend Developer with a passion for building efficient and reliable systems.
    My work on Smart Resume AI focuses on designing scalable architectures and ensuring secure, 
    high-performance functionality to power intelligent resume analysis.
</p>
        ...
        st.toast("Check out these repositories: [Iriswise](https://github.com/ShaikhAayan)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Awesome Java](https://github.com/ShaikhAayanii/Awesome-Java)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/ShaikhAayanii/AI-Nexus)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [GeeksforGeeks-POTD](https://github.com/ShaikhAayanii/GeeksforGeeks-POTD)", icon="ℹ️")
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [TryHackMe Free Rooms](https://github.com/ShaikhAayanii/tryhackme-free-rooms)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    <div style="margin-bottom: 10px;">Member</div>
    <div style="margin-bottom: 5px;"><b>Aayan</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
          <li><a href="https://amackcode.blogspot.com/" target="_blank" style="color: #4CAF50;">Aayan (Amack Blog)</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Sonali</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
     <li><a href="https://abaop.blogspot.com/" target="_blank" style="color: #4CAF50;">Sonali</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Harini</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
         <li><a href="https://harinimanikandan286.github.io/" target="_blank" style="color: #4CAF50;">Harini</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b></b></div>
    <div style="margin-top: 10px;">copyright@has</div>
</div>
"""
